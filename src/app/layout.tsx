...
export const metadata: Metadata = {
  ...
  description:
    "Genso – маркетинговое агентство и дизайн студио. Мы создаем уникальные бренды, впечатляющие веб-сайты и эффективные SMM-стратегии, чтобы ваш бизнес выделялся и рос.",
  openGraph: {
    title: "Генсо - Ваш надежный партнер по аутсорсингу",
    description:
      "Genso – маркетинговое агентство и дизайн студио. Мы создаем уникальные бренды, впечатляющие веб-сайты и эффективные SMM-стратегии, чтобы ваш бизнес выделялся и рос.",
